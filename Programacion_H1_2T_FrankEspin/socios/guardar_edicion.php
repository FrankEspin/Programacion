...
if (isset ($_POST['id_socio'])&&($_POST['nombre']) && isset($_POST['apellido']) && isset($_POST['email']) && isset($_POST['tipo_de_plan']) && isset($_POST['paquetes_adicionales']) && isset($_POST['duracion_de_suscripcion'])) {
    ...
    $exito = $controller->actualizarSocio($id_socio,$nombre, $apellido, $email, $tipo_de_plan, $paquetes_adicionales, $duracion_de_suscripcion);
    ...
    if ($exito) {
        ...
        $mensaje = "Hubo un problema al actualizar al socio. Intenta de nuevo.";
