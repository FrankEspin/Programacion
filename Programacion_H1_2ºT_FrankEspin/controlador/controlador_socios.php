...
class controlador_socios{
    ...
    public function guardarNuevoSocio($nombre, $apellido, $email, $tipo_de_plan, $paquetes_adicionales, $duracion_de_suscripcion) {
        // Llamar al método del modelo para guardar el nuevo socio
        return $this->modelo->guardarAlta($nombre, $apellido, $email, $tipo_de_plan, $paquetes_adicionales, $duracion_de_suscripcion);
    }
